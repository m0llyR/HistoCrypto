...
From 1980 as it's roughly the birth of the Motorola 68000, and the modern avalable computer.
    ...
    LOOK at NSA algorithms: https://www.cryptomuseum.com/crypto/algo/index.htm

    Below is a non-exhaustive overview of (secret) encryption algorithms 
    that have been developed by or for the US National Security Agency (NSA) 
    and that are further described on this website. These algorithms are 
    generally classed as an NSA Type 1 or Type 2 algorithm and are intended 
    for governmental and military use. More a more complete overview, check 
    out this page.
    ...
    in products like AIM, Cypris (SAVILLE I and II), Windster (SAVILLE I), 
    INDICTOR (SAVILLE I), VINSON (KY-57), Spendex 40 and Cougar.
